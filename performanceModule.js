...
export function init(content) {
    ...
    addForm.innerHTML = `
        ...
        <input type="number" id="revEmpId" placeholder="ID Nhân viên" required>
    ...
    function refreshReport() {
        reportDiv.innerHTML = '<h3>Báo cáo Hiệu suất</h3>';
        const table = document.createElement('table');
        table.innerHTML = '<thead><tr><th>ID Nhân viên</th><th>Điểm Trung bình</th></tr></thead><tbody></tbody>';
